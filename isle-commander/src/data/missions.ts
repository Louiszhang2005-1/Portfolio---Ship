...
export const missions: Mission[] = [
  // ── SECTOR A: INTERNSHIP HARBOR (Northwest) ──
  {
    id: "A1",
    sector: "Internship Harbor",
    sectorColor: "#cc0000",
    title: "Tesla Nevada",
  ...
  // ── SECTOR B: AERO ARCHIPELAGO (Northeast) ──
  {
    id: "B1",
    sector: "Aero Archipelago",
    sectorColor: "#b8860b",
  ...
  // ── SECTOR C: ROBOTICS REEF (Southwest) ──
  {
    id: "C1",
    sector: "Robotics Reef",
    sectorColor: "#c62828",
    title: "ResQ-Link",
  ...
  // ── SECTOR D: DIGITAL DELTA (Southeast) ──
  {
    id: "D1",
    sector: "Digital Delta",
    sectorColor: "#6a1b9a",
...
/** Get active missions only (excludes locked) */
